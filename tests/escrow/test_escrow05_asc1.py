...
from escrow.escrow05_asc1 import (
    approval_program,
    clear_state_program,
    global_schema,
    local_schema,
...
def test_init_app_payment_sender(
    ...
    with pytest.raises(AlgodHTTPError) as e:
        ...
        txn2 = PaymentTxn(test2_address, sp, receiver=app_address, amt=101000)
        sign_send_wait_group_transactions(
            client, [txn1, txn2], [test1_private_key, test2_private_key]
        )
    print(e)
...
def test_init_app_payment_receiver(
    ...
    with pytest.raises(AlgodHTTPError) as e:
        ...
        txn2 = PaymentTxn(test1_address, sp, receiver=test2_address, amt=101000)
        sign_send_wait_group_transactions(
            client, [txn1, txn2], [test1_private_key, test1_private_key]
        )
    print(e)
...
def test_init_app_payment_amount(
    ...
    with pytest.raises(AlgodHTTPError) as e:
        ...
        txn2 = PaymentTxn(test1_address, sp, receiver=app_address, amt=100000)
        sign_send_wait_group_transactions(
            client, [txn1, txn2], [test1_private_key, test1_private_key]
        )
    print(e)
